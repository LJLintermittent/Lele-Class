                ...
                <div class="cc-l-wrap">
                  ...
                  <section class="mt10 hLh20 of">
                    ...
                    <span class="fl jgAttr c-ccc f-fA">
                      <i class="c-999 f-fA">销量：{{ item.buyCount }}</i>
                      |
                      <i class="c-999 f-fA">浏览数量：{{ item.viewCount }}</i>
                    </span>
                  </section>
                </div>
              </li>
        ...
        <div>
          <div class="paging">
            ...
            <a
              ...
              title="后一页"
              @click.prevent="
                data.current != data.pages ? gotoPage(data.current + 1) : null
              "
              >&gt;</a
            >
            <a
              ...
              title="末页"
              @click.prevent="
                data.current != data.pages ? gotoPage(data.pages) : null
              "
              >末页</a
            >
            <div class="clear" />
